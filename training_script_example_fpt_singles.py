...
masker1 = masker.Masker(vocab, probability=0.15, mask_probability=0.8, random_probability=0.1)

train_filenames = glob(os.path.join('/disk/dragon-storage/homes/seber007/data/spectra/massive-kb-lowres', '*'))
...
train_index = AnnotatedSpectrumIndex(
    train_idx_fn, max_spectra_per_peptide=1, start_spec_ix = 200_000, end_spec_ix=1_200_000, ms_data_files=train_filenames, valid_charge=valid_charge
)
