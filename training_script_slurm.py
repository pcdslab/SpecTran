...
model1 = model.SpecBERT(vocab=vocab, vocab_size=len(vocab.all_tokens), max_token_length = 2, embed_dimension=512, hidden_dimension=1024, n_attn_layers=12, n_attn_heads=8, lr=5e-4, weight_decay=1e-5, warmup_iters=100_000, max_iters=600_000)

seed_everything(42, workers=True)

from pytorch_lightning import loggers as pl_loggers

ts_logger = pl_loggers.TensorBoardLogger(save_dir="test-march23/")
