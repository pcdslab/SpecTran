...
vocab1 = vocab.BasicSpectraVocab(2)    
vocab1.load_from_file("/disk/dragon-storage/homes/seber007/rat-pair-tokens-apr5.txt")
tokenizer1 = tokenizer.SpectraTokenizer(vocab1, 2, "1.0")
...
model1 = model_from_pretrained.SpecBERTUniversalComputation(vocab=vocab1, vocab_size=len(vocab1.all_tokens), max_token_length = 2, lr=5e-4, weight_decay=1e-5, warmup_iters=100_000, max_iters=600_000, model_name="BERT")

seed_everything(42, workers=True)

ts_logger = pl_loggers.TensorBoardLogger(save_dir="output-rat-bert-pairs/")
